...
![ONLY ``Environmental objectives"..EU-Taxonomy does not address S or G objectives. It cares about what counts as an environmentally sustainable economic activity? A firm needs to answer what is its % of business (economic activities) that is really GREEN.](images/6objectives.png){width="1000"}
...
To meet the E-objectives - Climate, Water, Pollution, Biodiversity, Circular Econ -, a firm discloses `what % of their business` that is  <span style="color: green;">Green</span>...in terms of the 3 KPIs - Revenue (what a firm does now), CAPEX (what a firm does for future), OPEX (how a firm supports its operation).  
...
![EU Taxonomy Regulation is accompanied by several Delegated Acts as well as additional guidance.](images/act.png){width="1000"}
...
![Table 4. Total turnover, capital expenditures, operating expenses. Once the activity is considered as T-eligible, its entire business portion is used to compute the T-eligible quota.](images/t4.png){width="500"}
...
![For each activity, we compute the three KPIs](images/a.png){width="1000"}

...
$$
Let's reconcile CUber's accident frequency measure with the dimension used for S1 reporting and compare the values for the whole firm between CAP and CUber. **If the accident frequency rate (AFR) exceeds the one of CAP by more than 20%, the deal fails**. This means
$$
